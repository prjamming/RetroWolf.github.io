function start() {
  ...
  var link = "https://guitarflash3.com/setlist/"; // link to app webpage
  var id = "https://retrowolf.github.io/clockwork/guitarflash.js"; // set this to the url location of your script
  ...
  ExampleLink.innerHTML = "<img src=\"https://t1.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=" + link + "&size=16\"width=\"24px\" height=\"24px\">";  
